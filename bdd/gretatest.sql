...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 15 Novembre 2016 à 16:56
...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateDetail`(IN Pcode_Detail varchar(45),IN PNom_Detail varchar(45),IN Pdescript varchar(255),IN Pheure_Detail INT,IN Pevaluable tinyint,IN PidDetailParent INT,IN PidTheme INT, OUT Pid_Detail INT)
BEGIN
INSERT INTO detail(code_Detail, Nom_Detail, descript_Detail, etat_Detail, objectif_Detail, heure_Detail, evaluable, idDetailParent, idTheme, det_ref)
values(Pcode_Detail,PNom_Detail,Pdescript,'inactif',Pheure_Detail,Pevaluable,PidDetailParent,PidTheme,0);
SELECT LAST_INSERT_ID() INTO Pid_Detail
FROM detail;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateModule`(IN PidCompetence INT,IN PidMatiere INT,IN PidTheme INT,IN PidFormateurs_Suivi INT,IN PidFormateurs_createur INT,IN PidParcours INT,IN PNom_mod varchar(45),IN Pdescript_mod varchar(255),IN Petat_mod varchar(45),IN Pheure_mod INT,IN Pcode_module varchar(45),OUT Pidmodule INT)
BEGIN
INSERT INTO modules(idCompetence,idMatiere,idTheme,idFormateurs_Suivi,idFormateurs_createur,idParcours,Nom_mod,descript_mod,etat_mod,heure_mod,code_module,mod_ref)
values(PidCompetence,PidMatiere,PidTheme,PidFormateurs_Suivi,PidFormateurs_createur,PidParcours,PNom_mod,Pdescript_mod,Petat_mod,Pheure_mod,Pcode_module,0);
SELECT LAST_INSERT_ID() INTO Pidmodule
FROM modules;
...
-- Fonctions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `CreateDetail`( Pcode_Detail varchar(45), PNom_Detail varchar(45), Pdescript varchar(255),Pobjectif_Detail varchar(255),Pheure_Detail INT, Pevaluable tinyint, PidDetailParent INT, PidTheme INT) RETURNS int(11)
BEGIN
declare Pid_Detail int; 
INSERT INTO detail(code_Detail, Nom_Detail, descript_Detail, etat_Detail, objectif_Detail, heure_Detail, evaluable, idDetailParent, idTheme, det_ref)
values(Pcode_Detail,PNom_Detail,Pdescript,'inactif',Pobjectif_Detail,Pheure_Detail,Pevaluable,PidDetailParent,PidTheme,0);
SELECT id_Detail INTO Pid_Detail
FROM detail where id_Detail = LAST_INSERT_ID();
return Pid_Detail;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `CreateModule`(PidCompetence INT,PidMatiere INT,PidTheme INT,PidFormateurs_Suivi INT,PidFormateurs_createur INT,PidParcours INT,PNom_mod varchar(45),Pdescript_mod varchar(255),Petat_mod varchar(45),Pheure_mod INT,Pcode_module varchar(45)) RETURNS int(11)
BEGIN
declare Pidmodule int;
INSERT INTO modules(idCompetence,idMatiere,idTheme,idFormateurs_Suivi,idFormateurs_createur,idParcours,Nom_mod,descript_mod,etat_mod,heure_mod,code_module,mod_ref)
values(PidCompetence,PidMatiere,PidTheme,PidFormateurs_Suivi,PidFormateurs_createur,PidParcours,PNom_mod,Pdescript_mod,Petat_mod,Pheure_mod,Pcode_module,0);
SELECT idModules INTO Pidmodule
FROM modules where idModules = LAST_INSERT_ID();
return Pidmodule;
...
--
-- Structure de la table `admin_parcours`
--

CREATE TABLE IF NOT EXISTS `admin_parcours` (
  `idAdmin_parcours` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `code_adminparc` varchar(45) DEFAULT NULL,
  `Nom_adminparc` varchar(45) DEFAULT NULL,
  `Prenom_adminparc` varchar(45) DEFAULT NULL,
  `log_adminparc` varchar(45) DEFAULT NULL,
  `mdp_adminparc` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idAdmin_parcours`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Contenu de la table `admin_parcours`
--

INSERT INTO `admin_parcours` (`idAdmin_parcours`, `code_adminparc`, `Nom_adminparc`, `Prenom_adminparc`, `log_adminparc`, `mdp_adminparc`) VALUES
(1, NULL, 'martin', 'vincent', NULL, NULL),
(2, NULL, 'meunier', 'catherine', NULL, NULL),
(3, NULL, 'audier', 'philippe', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `competence` (
  ...
  `Desc_Comp` varchar(255) DEFAULT NULL,
  `Code_Comp` varchar(255) DEFAULT NULL,
...
INSERT INTO `competence` (`idCompetence`, `Nom_Comp`, `Desc_Comp`, `Code_Comp`) VALUES
(1, 'programmer', 'apprendre a programmer en langage binaire', NULL),
(2, 'concevoir une base de données', 'apprendre a programmer concevoir une BDD', NULL),
(3, 'développer', 'apprendre a développer une base de données en langage binaire', NULL);
...
CREATE TABLE IF NOT EXISTS `contenu_parcours` (
  `idModules` int(10) unsigned NOT NULL,
...
--
-- Contenu de la table `contenu_parcours`
--

INSERT INTO `contenu_parcours` (`idModules`, `idFormation`) VALUES
(1, 2),
(9, 2),
(1, 16),
(9, 16),
...
CREATE TABLE IF NOT EXISTS `detail` (
  ...
  `code_Detail` varchar(45) DEFAULT NULL,
  `Nom_Detail` varchar(45) DEFAULT NULL,
  `descript_Detail` varchar(255) DEFAULT NULL,
  `etat_Detail` varchar(45) DEFAULT NULL,
  `objectif_Detail` varchar(255) DEFAULT NULL,
  `heure_Detail` int(10) unsigned DEFAULT NULL,
  `evaluable` tinyint(1) DEFAULT NULL,
  `idDetailParent` int(10) unsigned DEFAULT NULL,
  `idTheme` int(10) unsigned zerofill NOT NULL,
  `det_ref` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_Detail`),
  KEY `idModules` (`idDetailParent`),
  KEY `fk_det_idtheme` (`idTheme`)
...
INSERT INTO `detail` (`id_Detail`, `code_Detail`, `Nom_Detail`, `descript_Detail`, `etat_Detail`, `objectif_Detail`, `heure_Detail`, `evaluable`, `idDetailParent`, `idTheme`, `det_ref`) VALUES
(3, NULL, 'mcd', 'modele conceptuel de données', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(4, NULL, 'entrée clavier et sortie ecran', 'systeme de communication avec l''utilisateur', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(5, NULL, 'gfdsg', 'gfdsg', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(6, NULL, 'synphony2 prise en main', 'prise en main de frameworks', NULL, NULL, NULL, NULL, NULL, 0000000002, 1),
(7, NULL, 'mld', 'm logique de données', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(8, NULL, 'mct', 'm conceptuel de d', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(9, NULL, 'condition si', 'if, else if , else ', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(10, NULL, 'boucles', 'boucles for / while', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(11, NULL, 'java prise en main', 'prise en main de java', NULL, NULL, NULL, NULL, NULL, 0000000002, 1),
(12, NULL, 'php prise en main', 'les bases de php', NULL, NULL, NULL, NULL, NULL, 0000000002, 1),
(13, NULL, 'javascript prise en main', 'debut de javascript', NULL, NULL, NULL, NULL, NULL, 0000000002, 1),
(14, NULL, 'diagramme de sequence', 'diagramme de sequence', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(15, NULL, 'java', 'bases', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(26, NULL, 'cv', 'faire son cv', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(27, NULL, 'postuler', 'postuler', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(28, NULL, 'chercher un emploi', 'chercher un emploi', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(29, NULL, 'devenir developpeur', 'devenir developpeur', NULL, NULL, NULL, NULL, NULL, 0000000003, 1),
(30, NULL, 'select from', 'sql base', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(31, NULL, 'where', 'sql un peu plus', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(32, NULL, 'in ou  =', 'encore un peu plus', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(33, NULL, 'imbrication', 'ca devient chaud', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(34, NULL, 'correlation', 'mal à la tête', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(35, NULL, 'fin sql les scripts', 'il était temps!', NULL, NULL, NULL, NULL, NULL, 0000000001, 1),
(53, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(54, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(55, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(56, NULL, 'cv', 'faire son cv', 'inactif', NULL, NULL, NULL, 10, 0000000003, 0),
(57, NULL, 'postuler', 'postuler', 'inactif', NULL, NULL, NULL, 10, 0000000003, 0),
(58, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(59, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(60, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(61, NULL, 'synphony2 prise en main', 'prise en main de frameworks', 'inactif', NULL, NULL, NULL, 11, 0000000002, 0),
(62, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(63, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(64, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(65, NULL, 'imbrication', 'ca devient chaud', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(66, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(67, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(68, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(69, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(70, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(71, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(72, NULL, 'select from', 'sql base', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(73, NULL, 'where', 'sql un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0),
(74, NULL, 'in ou  =', 'encore un peu plus', 'inactif', NULL, NULL, NULL, 2, 0000000001, 0);

-- --------------------------------------------------------

--
-- Structure de la table `detail_module`
--

CREATE TABLE IF NOT EXISTS `detail_module` (
  `idModules` int(10) unsigned NOT NULL,
...
--
-- Contenu de la table `detail_module`
--

INSERT INTO `detail_module` (`idModules`, `id_Detail`) VALUES
(40, 3),
(11, 4),
(38, 4),
(40, 4),
...
CREATE TABLE IF NOT EXISTS `formateurs` (
  `idFormateurs` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `code_formateur` varchar(45) DEFAULT NULL,
  `nom_form` varchar(255) DEFAULT NULL,
  `prenom_form` varchar(255) DEFAULT NULL,
  `adr_form` varchar(255) DEFAULT NULL,
  `log_form` varchar(255) DEFAULT NULL,
  `mdp_form` varchar(255) DEFAULT NULL,
  `etat_form` varchar(45) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `formation` (
  ...
  `idType_Form` int(10) unsigned NOT NULL,
  `idAdmin_parcours` int(10) unsigned NOT NULL,
  `idFormateurs` int(10) unsigned DEFAULT NULL,
  `nom_Form` varchar(45) DEFAULT NULL,
  `desc_Form` varchar(255) DEFAULT NULL,
  `etat_Form` varchar(45) DEFAULT NULL,
  `code_Form` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idFormation`),
  KEY `idType_Form` (`idType_Form`),
  KEY `idAdmin_parcours` (`idAdmin_parcours`),
  KEY `idFormateurs` (`idFormateurs`)
...
INSERT INTO `formation` (`idFormation`, `idType_Form`, `idAdmin_parcours`, `idFormateurs`, `nom_Form`, `desc_Form`, `etat_Form`, `code_Form`) VALUES
(1, 2, 1, NULL, 'bts sio', 'science informatique organanisé', NULL, NULL),
(2, 1, 1, NULL, 'gfqdsbggd', 'bgdsbgfsbgfs', NULL, NULL),
(3, 1, 1, NULL, 'bts sio', 'science informatique organanisé', NULL, NULL),
(4, 1, 1, NULL, 'cdi', 'concepteur developpeur', NULL, NULL),
(5, 2, 2, NULL, 'bts comptabilité', 'comptabilité gestion appliquée', NULL, NULL),
(6, 2, 3, NULL, 'bts sio slam', 'science informatique  langage multiple', NULL, NULL),
(7, 3, 2, NULL, 'concepteur de bdd', 'conception de bdd', NULL, NULL),
(8, 3, 1, NULL, 'cdi', 'bgdsbgfsbgfs', NULL, NULL),
(9, 2, 2, NULL, 'bts tegery', 'informatique et reseau', NULL, NULL),
(10, 2, 2, NULL, 'bts tegery 2', 'informatique et reseau', NULL, NULL),
(11, 2, 2, NULL, 'bts tegery 2', 'informatique et reseau', NULL, NULL),
(12, 2, 2, NULL, 'bts tegery ', 'informatique et reseau', NULL, NULL),
(13, 2, 2, NULL, 'bts tegery 3', 'informatique et reseau', NULL, NULL),
(14, 1, 2, NULL, 'informatique de gestion', 'comptabilité gestion appliquée', NULL, NULL),
(15, 1, 2, NULL, 'informatique de gestion', 'comptabilité gestion appliquée', NULL, NULL),
(16, 2, 3, NULL, 'cdi 2', 'concepteur developpeur', NULL, NULL),
(17, 1, 2, NULL, 'compta', 'compta', NULL, NULL),
(18, 2, 2, NULL, 'gfqdsbggd', 'concepteur developpeur', NULL, NULL),
(19, 1, 1, NULL, 'ssis', 'une formation interessante', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `tailleimg` varchar(20) DEFAULT NULL,
  `typeimg` varchar(45) DEFAULT NULL,
  `descimg` varchar(255) DEFAULT NULL,
  `img` blob,
  PRIMARY KEY (`idImage`),
  KEY `fk_stag_idstag` (`idStagiaire`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `matiere` (
  ...
  `code_matiere` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `matiere` (`idMatiere`, `code_matiere`, `Nom_Matiere`) VALUES
(1, NULL, 'developpement'),
(2, NULL, 'comptabilité'),
(3, NULL, 'réseau');
...
--
-- Structure de la table `mle6g_assets`
--

CREATE TABLE IF NOT EXISTS `mle6g_assets` (
...
--
-- Contenu de la table `mle6g_assets`
--

INSERT INTO `mle6g_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 49, 100, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(39, 18, 50, 51, 2, 'com_modules.module.1', 'Menu principal', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
...
(51, 18, 74, 75, 2, 'com_modules.module.17', 'Fil de navigation', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
...
(57, 18, 86, 87, 2, 'com_modules.module.90', 'Derniers articles', '{"core.delete":{"6":1},"core.edit":{"4":1,"6":1},"core.edit.state":{"5":1,"6":1},"module.edit.frontend":[]}'),
(58, 18, 88, 89, 2, 'com_modules.module.91', 'Menu utilisateur', '{"core.delete":{"6":1},"core.edit":{"4":1,"6":1},"core.edit.state":{"5":1,"6":1},"module.edit.frontend":[]}'),
(59, 18, 90, 91, 2, 'com_modules.module.92', 'Images aléatoire', '{"core.delete":{"6":1},"core.edit":{"4":1,"6":1},"core.edit.state":{"5":1,"6":1},"module.edit.frontend":[]}'),
(60, 18, 92, 93, 2, 'com_modules.module.93', 'Recherche', '{"core.delete":{"6":1},"core.edit":{"4":1,"6":1},"core.edit.state":{"5":1,"6":1},"module.edit.frontend":[]}'),
...
(63, 8, 22, 25, 2, 'com_content.category.8', 'info', '{"core.edit":{"15":1,"13":1,"14":1},"core.create":{"13":1},"core.delete":{"13":1}}'),
(64, 8, 26, 29, 2, 'com_content.category.9', 'compta', '{"core.create":{"14":1},"core.delete":{"14":1},"core.edit":{"14":1,"13":1,"16":1}}'),
(65, 63, 23, 24, 3, 'com_content.article.2', 'informatique', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(66, 64, 27, 28, 3, 'com_content.article.3', 'compta', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(67, 18, 94, 95, 2, 'com_modules.module.94', 'connexion utilisateur', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
(68, 18, 96, 97, 2, 'com_modules.module.95', 'user login', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
(69, 18, 98, 99, 2, 'com_modules.module.96', 'Login', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_associations`
--

CREATE TABLE IF NOT EXISTS `mle6g_associations` (
...
--
-- Structure de la table `mle6g_banners`
--

CREATE TABLE IF NOT EXISTS `mle6g_banners` (
...
--
-- Structure de la table `mle6g_banner_clients`
--

CREATE TABLE IF NOT EXISTS `mle6g_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `mle6g_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `mle6g_banner_tracks` (
...
--
-- Structure de la table `mle6g_categories`
--

CREATE TABLE IF NOT EXISTS `mle6g_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `mle6g_categories`
--

INSERT INTO `mle6g_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 15, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'non-categorise', 'com_content', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'non-categorise', 'com_banners', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'non-categorise', 'com_contact', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'non-categorise', 'com_newsfeeds', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'non-categorise', 'com_users', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 432, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 63, 1, 11, 12, 1, 'info', 'com_content', 'info', 'info', '', '', 1, 0, '0000-00-00 00:00:00', 8, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 432, '2016-10-10 09:46:55', 432, '2016-10-10 11:30:24', 0, '*', 1),
(9, 64, 1, 13, 14, 1, 'compta', 'com_content', 'compta', 'compta', '', '', 1, 0, '0000-00-00 00:00:00', 7, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 432, '2016-10-10 09:47:35', 432, '2016-10-10 11:30:36', 0, '*', 1);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_contact_details`
--

CREATE TABLE IF NOT EXISTS `mle6g_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Structure de la table `mle6g_content`
--

CREATE TABLE IF NOT EXISTS `mle6g_content` (
...
--
-- Contenu de la table `mle6g_contentitem_tag_map`
--

INSERT INTO `mle6g_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `mle6g_content_frontpage` (
...
--
-- Structure de la table `mle6g_content_rating`
--

CREATE TABLE IF NOT EXISTS `mle6g_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `mle6g_content_types`
--

CREATE TABLE IF NOT EXISTS `mle6g_content_types` (
...
--
-- Contenu de la table `mle6g_content_types`
--

INSERT INTO `mle6g_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Structure de la table `mle6g_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `mle6g_core_log_searches` (
...
--
-- Structure de la table `mle6g_extensions`
--

CREATE TABLE IF NOT EXISTS `mle6g_extensions` (
...
--
-- Contenu de la table `mle6g_extensions`
--

INSERT INTO `mle6g_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(23, 'com_config', 'component', 'com_config', '', 1, 1, 0, 1, '{"name":"com_config","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"COM_CONFIG_XML_DESCRIPTION","group":""}', '{"filters":{"1":{"filter_type":"NH","filter_tags":"","filter_attributes":""},"2":{"filter_type":"NH","filter_tags":"","filter_attributes":""},"10":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"3":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"4":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"5":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"11":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"14":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"13":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"12":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"16":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"15":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"6":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"7":{"filter_type":"NONE","filter_tags":"","filter_attributes":""},"9":{"filter_type":"BL","filter_tags":"","filter_attributes":""},"8":{"filter_type":"NONE","filter_tags":"","filter_attributes":""}}}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"268918c8cc627b887b2563fa78e6819b"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1476456807}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Structure de la table `mle6g_finder_filters`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_filters` (
...
--
-- Structure de la table `mle6g_finder_links`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links` (
...
--
-- Structure de la table `mle6g_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms0` (
...
--
-- Structure de la table `mle6g_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `mle6g_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Contenu de la table `mle6g_finder_taxonomy`
--

INSERT INTO `mle6g_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Structure de la table `mle6g_finder_terms`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_terms` (
...
--
-- Structure de la table `mle6g_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Contenu de la table `mle6g_finder_terms_common`
--

INSERT INTO `mle6g_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Structure de la table `mle6g_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Structure de la table `mle6g_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Structure de la table `mle6g_finder_types`
--

CREATE TABLE IF NOT EXISTS `mle6g_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `mle6g_languages`
--

CREATE TABLE IF NOT EXISTS `mle6g_languages` (
...
--
-- Contenu de la table `mle6g_languages`
--

INSERT INTO `mle6g_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Structure de la table `mle6g_menu`
--

CREATE TABLE IF NOT EXISTS `mle6g_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `mle6g_menu`
--

INSERT INTO `mle6g_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Contenu de la table `mle6g_menu_types`
--

INSERT INTO `mle6g_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
--
-- Structure de la table `mle6g_messages`
--

CREATE TABLE IF NOT EXISTS `mle6g_messages` (
...
--
-- Structure de la table `mle6g_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `mle6g_messages_cfg` (
...
--
-- Structure de la table `mle6g_modules`
--

CREATE TABLE IF NOT EXISTS `mle6g_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Contenu de la table `mle6g_modules`
--

INSERT INTO `mle6g_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Menu principal', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 2, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":" nav-pills","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(16, 50, 'Connexion', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '2016-10-10 11:07:45', '0000-00-00 00:00:00', -2, 'mod_login', 1, 1, '{"pretext":"coucou","posttext":"","login":"101","logout":"101","greeting":"1","name":"0","usesecure":"0","usetext":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(87, 54, 'Tags populaires', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '2016-10-10 11:07:45', '0000-00-00 00:00:00', -2, 'mod_tags_popular', 1, 1, '{"maximum":"10","timeframe":"alltime","order_value":"count","order_direction":"1","display_count":0,"no_results_text":"0","minsize":1,"maxsize":2,"layout":"_:default","moduleclass_sfx":"","owncache":"1","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(90, 57, 'Derniers articles', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_articles_latest', 2, 1, '{"catid":[""],"count":"5","show_featured":"","ordering":"c_dsc","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(91, 58, 'Menu utilisateur', '', '', 3, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 2, 1, '{"menutype":"usermenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(92, 59, 'Images aléatoire', '', '<p><img src="images/headers/blue-flower.jpg" alt="Blue Flower" /></p>', 1, 'position-3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 2, 0, '{"prepare_content":"1","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(93, 60, 'Recherche', '', '', 1, 'position-0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_search', 2, 1, '{"label":"","width":"20","text":"","button":"0","button_pos":"right","imagebutton":"1","button_text":"","opensearch":"1","opensearch_title":"","set_itemid":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(94, 67, 'connexion utilisateur', '', '', 1, 'position-7', 432, '2016-10-10 10:47:45', '2016-10-10 11:07:45', '0000-00-00 00:00:00', -2, 'mod_login', 1, 1, '{"pretext":"Bonjour,\\r\\nMerci de vous connecter :","posttext":"","login":"101","logout":"101","greeting":"1","name":"0","usesecure":"0","usetext":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(95, 68, 'user login', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '2016-10-10 11:07:45', '0000-00-00 00:00:00', -2, 'mod_login', 2, 1, '{"pretext":"","posttext":"","login":"","logout":"","greeting":"1","name":"0","usesecure":"0","usetext":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(96, 69, 'Login', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 2, 1, '{"pretext":"","posttext":"","login":"","logout":"","greeting":"1","name":"0","usesecure":"0","usetext":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_modules_menu`
--

CREATE TABLE IF NOT EXISTS `mle6g_modules_menu` (
...
--
-- Contenu de la table `mle6g_modules_menu`
--

INSERT INTO `mle6g_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Structure de la table `mle6g_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `mle6g_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `mle6g_overrider`
--

CREATE TABLE IF NOT EXISTS `mle6g_overrider` (
...
--
-- Structure de la table `mle6g_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `mle6g_postinstall_messages` (
...
--
-- Contenu de la table `mle6g_postinstall_messages`
--

INSERT INTO `mle6g_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Structure de la table `mle6g_redirect_links`
--

CREATE TABLE IF NOT EXISTS `mle6g_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `mle6g_schemas`
--

CREATE TABLE IF NOT EXISTS `mle6g_schemas` (
...
--
-- Contenu de la table `mle6g_schemas`
--

INSERT INTO `mle6g_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.0-2016-06-05');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_session`
--

CREATE TABLE IF NOT EXISTS `mle6g_session` (
...
--
-- Contenu de la table `mle6g_session`
--

INSERT INTO `mle6g_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('r7u1ik0utv1fgj9vcj4jgiq0n6', 0, 0, '1476457162', 'joomla|s:928:"";', 433, 'prof1');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_tags`
--

CREATE TABLE IF NOT EXISTS `mle6g_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `mle6g_tags`
--

INSERT INTO `mle6g_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 3, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 432, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 432, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_template_styles`
--

CREATE TABLE IF NOT EXISTS `mle6g_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `mle6g_template_styles`
--

INSERT INTO `mle6g_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Structure de la table `mle6g_ucm_base`
--

CREATE TABLE IF NOT EXISTS `mle6g_ucm_base` (
...
--
-- Contenu de la table `mle6g_ucm_base`
--

INSERT INTO `mle6g_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_ucm_content`
--

CREATE TABLE IF NOT EXISTS `mle6g_ucm_content` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Contains core content data in name spaced fields' AUTO_INCREMENT=2 ;

--
-- Contenu de la table `mle6g_ucm_content`
--

INSERT INTO `mle6g_ucm_content` (`core_content_id`, `core_type_alias`, `core_title`, `core_alias`, `core_body`, `core_state`, `core_checked_out_time`, `core_checked_out_user_id`, `core_access`, `core_params`, `core_featured`, `core_metadata`, `core_created_user_id`, `core_created_by_alias`, `core_created_time`, `core_modified_user_id`, `core_modified_time`, `core_language`, `core_publish_up`, `core_publish_down`, `core_content_item_id`, `asset_id`, `core_images`, `core_urls`, `core_hits`, `core_version`, `core_ordering`, `core_metakey`, `core_metadesc`, `core_catid`, `core_xreference`, `core_type_id`) VALUES
(1, 'com_content.article', 'Comment débuter ?', 'comment-debuter', '<p>La création d''un site web avec Joomla est simple, le déploiement de ce site exemple vous y aidera. <br />Les quelques principes de base présentés ci-dessous vous guideront dans la compréhension de ce logiciel.</p><h3>Qu''est-ce qu''un Système de Gestion de Contenu ?</h3><p>Un   système de gestion de contenu (SGC ou CMS de l''anglais Content  Management System) est un logiciel qui vous permet de créer  et gérer  des pages Web facilement, séparant la création des contenus de la  gestion technique nécessaire à une diffusion sur le web.</p><p>Le  contenu rédactionnel est stocké et restitué par une base de données, l''aspect (police, taille, couleur, emplacement, etc.) est géré par un  template (habillage du site). Le logiciel Joomla permet d''unir ces deux  structures de manière conviviale et de les rendre accessibles au plus  grand nombre d''utilisateurs.</p><h3>Deux interfaces</h3><p>Un site Joomla est structuré en deux parties distinctes : la partie visible du site appelée «Frontal» de <em>Frontend</em> en anglais et, la partie d''administration pure appelée «Administration» de <em>Administrator</em>.</p><h3>Administration</h3><p>Vous pouvez accéder à l''administration en cliquant sur le sur le lien «Administration» présent dans le module de menu «Menu membre» visible après vous être connecté sur le site ou, en  ajoutant  <em>/administrator</em> dans l''URL après le nom de domaine (exemple : www.mon-domaine.com/administrator).</p><p>Utilisez le nom d''utilisateur et le mot de passe créés lors de l''installation de Joomla.</p><h3>Frontal</h3><p>Si votre profil possède les droits suffisants, vous pouvez créer des articles et les éditer depuis l''interface frontale du site.</p><p>Connectez-vous par le module «Connexion» en utilisant le nom d''utilisateur et le mot de passe créés lors de l''installation de Joomla.</p><h3>Créer un article en frontal</h3><p>Lorsque vous êtes connecté, un nouveau menu nommé «Menu Membres» apparaît. Cliquez sur le lien  «Créer un article» pour afficher l''éditeur de texte et d''insertion de médias.</p><p>Pour enregistrer l''article, vous devez spécifier à quelle catégorie il appartient ainsi que son statut de publication. Pour le modifier, cliquez sur l''icône d''édition <img src="media/system/images/edit.png" border="0" alt="Editer un article" width="18" height="18" style="vertical-align: middle;" />.</p><p>Vous pouvez travailler sur des articles non publiés ou de publication programmée dans le temps et, dans le cadre d''un travail collaboratif, ne les rendre visibles qu''à un groupe d''utilisateurs donnés avant de les rendre publics.</p><h3>En savoir plus</h3><p>Une pleine utilisation de Joomla requiert certaines connaissances approfondies que vous pourrez acquérir dans la <a href="http://docs.joomla.org/" target="_blank">documentation officielle de Joomla</a> ou sur le <a href="http://aide.joomla.fr/" target="_blank">site d''aide francophone</a> et dans le <a href="http://forum.joomla.org/" target="_blank">forum officiel</a> ou le <a href="http://forum.joomla.fr/" target="_blank">forum francophone</a>.</p>', 1, '', 0, 1, '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 0, '{"robots":"","author":"","rights":"","xreference":""}', 432, '', '2013-11-16 00:00:00', 0, '0000-00-00 00:00:00', '*', '2013-11-16 00:00:00', '0000-00-00 00:00:00', 1, 62, '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', 0, 1, 0, '', '', 2, '', 1);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_ucm_history`
--

CREATE TABLE IF NOT EXISTS `mle6g_ucm_history` (
...
--
-- Contenu de la table `mle6g_ucm_history`
--

INSERT INTO `mle6g_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 2, 10, 'Initial content', '2013-11-16 00:00:00', 432, 558, 'be28228b479aa67bad3dc1db2975232a033d5f0f', '{"id":2,"parent_id":"1","lft":"1","rgt":2,"level":1,"path":"joomla","title":"Joomla","alias":"joomla","note":"","description":null,"published":1,"checked_out":"0","checked_out_time":"0000-00-00 00:00:00","access":1,"params":null,"metadesc":null,"metakey":null,"metadata":null,"created_user_id":"849","created_time":"2013-11-16 00:00:00","created_by_alias":"","modified_user_id":"0","modified_time":"0000-00-00 00:00:00","images":null,"urls":null,"hits":"0","language":"*","version":"1","publish_up":"0000-00-00 00:00:00","publish_down":"0000-00-00 00:00:00"}', 0),
(2, 1, 1, 'Initial content', '2013-11-16 00:00:00', 432, 4539, '4f6bf8f67e89553853c3b6e8ed0a6111daaa7a2f', '{"id":1,"asset_id":54,"title":"Getting Started","alias":"getting-started","introtext":"<p>It''s easy to get started creating your website. Knowing some of the basics will help.<\\/p>\\r\\n<h3>What is a Content Management System?<\\/h3>\\r\\n<p>A content management system is software that allows you to create and manage webpages easily by separating the creation of your content from the mechanics required to present it on the web.<\\/p>\\r\\n<p>In this site, the content is stored in a <em>database<\\/em>. The look and feel are created by a <em>template<\\/em>. Joomla! brings together the template and your content to create web pages.<\\/p>\\r\\n<h3>Logging in<\\/h3>\\r\\n<p>To login to your site use the user name and password that were created as part of the installation process. Once logged-in you will be able to create and edit articles and modify some settings.<\\/p>\\r\\n<h3>Creating an article<\\/h3>\\r\\n<p>Once you are logged-in, a new menu will be visible. To create a new article, click on the \\"Submit Article\\" link on that menu.<\\/p>\\r\\n<p>The new article interface gives you a lot of options, but all you need to do is add a title and put something in the content area. To make it easy to find, set the state to published.<\\/p>\\r\\n<div>You can edit an existing article by clicking on the edit icon (this only displays to users who have the right to edit).<\\/div>\\r\\n<h3>Template, site settings, and modules<\\/h3>\\r\\n<p>The look and feel of your site is controlled by a template. You can change the site name, background colour, highlights colour and more by editing the template settings. Click the \\"Template Settings\\" in the user menu.\\u00a0<\\/p>\\r\\n<p>The boxes around the main content of the site are called modules. \\u00a0You can modify modules on the current page by moving your cursor to the module and clicking the edit link. Always be sure to save and close any module you edit.<\\/p>\\r\\n<p>You can change some site settings such as the site name and description by clicking on the \\"Site Settings\\" link.<\\/p>\\r\\n<p>More advanced options for templates, site settings, modules, and more are available in the site administrator.<\\/p>\\r\\n<h3>Site and Administrator<\\/h3>\\r\\n<p>Your site actually has two separate sites. The site (also called the front end) is what visitors to your site will see. The administrator (also called the back end) is only used by people managing your site. You can access the administrator by clicking the \\"Site Administrator\\" link on the \\"User Menu\\" menu (visible once you login) or by adding \\/administrator to the end of your domain name. The same user name and password are used for both sites.<\\/p>\\r\\n<h3>Learn more<\\/h3>\\r\\n<p>There is much more to learn about how to use Joomla! to create the web site you envision. You can learn much more at the <a href=\\"https:\\/\\/docs.joomla.org\\" target=\\"_blank\\">Joomla! documentation site<\\/a> and on the<a href=\\"http:\\/\\/forum.joomla.org\\" target=\\"_blank\\"> Joomla! forums<\\/a>.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2013-11-16 00:00:00","created_by":"849","created_by_alias":"","modified":"","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2013-11-16 00:00:00","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(3, 8, 5, '', '2016-10-10 09:46:55', 432, 545, '94a340059a635bb3613d55142ecd4b0c916f23c7', '{"id":8,"asset_id":63,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_content","title":"info","alias":"info","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"432","created_time":"2016-10-10 09:46:55","modified_user_id":null,"modified_time":"2016-10-10 09:46:55","hits":"0","language":"*","version":null}', 0),
(4, 9, 5, '', '2016-10-10 09:47:35', 432, 549, '99ad2f80312b71fb567505c4925b972673f58743', '{"id":9,"asset_id":64,"parent_id":"1","lft":"13","rgt":14,"level":1,"path":null,"extension":"com_content","title":"compta","alias":"compta","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"432","created_time":"2016-10-10 09:47:35","modified_user_id":null,"modified_time":"2016-10-10 09:47:35","hits":"0","language":"*","version":null}', 0),
(5, 2, 1, '', '2016-10-10 10:05:15', 432, 1692, '99739f9610a126544f88022d30676288efbb979c', '{"id":2,"asset_id":65,"title":"informatique","alias":"informatique","introtext":"","fulltext":"","state":1,"catid":"8","created":"2016-10-10 10:05:15","created_by":"432","created_by_alias":"","modified":"2016-10-10 10:05:15","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-10-10 10:05:15","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":1,"metakey":"","metadesc":"","access":"8","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(6, 3, 1, '', '2016-10-10 10:05:32', 432, 1680, 'e9846571d4d5d1640c159ac6d18f7ba9214f81ad', '{"id":3,"asset_id":66,"title":"compta","alias":"compta","introtext":"","fulltext":"","state":1,"catid":"9","created":"2016-10-10 10:05:32","created_by":"432","created_by_alias":"","modified":"2016-10-10 10:05:32","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-10-10 10:05:32","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"info_block_show_title\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":1,"metakey":"","metadesc":"","access":"7","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(7, 8, 5, '', '2016-10-10 11:30:24', 432, 571, '6cc67aa1f6edf82f1b6a8e7fffd7032f5391cea4', '{"id":8,"asset_id":"63","parent_id":"1","lft":"11","rgt":"12","level":"1","path":"info","extension":"com_content","title":"info","alias":"info","note":"","description":"","published":"1","checked_out":"432","checked_out_time":"2016-10-10 11:30:14","access":"8","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"432","created_time":"2016-10-10 09:46:55","modified_user_id":"432","modified_time":"2016-10-10 11:30:24","hits":"0","language":"*","version":"1"}', 0),
(8, 9, 5, '', '2016-10-10 11:30:36', 432, 577, 'e23c4a48a0814434ca85b7bed8677fb1ba7b72d2', '{"id":9,"asset_id":"64","parent_id":"1","lft":"13","rgt":"14","level":"1","path":"compta","extension":"com_content","title":"compta","alias":"compta","note":"","description":"","published":"1","checked_out":"432","checked_out_time":"2016-10-10 11:30:28","access":"7","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"432","created_time":"2016-10-10 09:47:35","modified_user_id":"432","modified_time":"2016-10-10 11:30:36","hits":"0","language":"*","version":"1"}', 0);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_updates`
--

CREATE TABLE IF NOT EXISTS `mle6g_updates` (
...
--
-- Contenu de la table `mle6g_updates`
--

INSERT INTO `mle6g_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(8, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.6.3.1', '', 'https://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
...
(51, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.5.1.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
...
--
-- Structure de la table `mle6g_update_sites`
--

CREATE TABLE IF NOT EXISTS `mle6g_update_sites` (
...
--
-- Contenu de la table `mle6g_update_sites`
--

INSERT INTO `mle6g_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1476456809, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1476456809, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1476109566, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1476109567, '');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `mle6g_update_sites_extensions` (
...
--
-- Contenu de la table `mle6g_update_sites_extensions`
--

INSERT INTO `mle6g_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Structure de la table `mle6g_usergroups`
--

CREATE TABLE IF NOT EXISTS `mle6g_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Contenu de la table `mle6g_usergroups`
--

INSERT INTO `mle6g_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 32, 'Public'),
(2, 1, 2, 23, 'Enregistré'),
(3, 2, 5, 10, 'Auteur'),
(4, 3, 6, 9, 'Rédacteur'),
...
(9, 1, 28, 29, 'Invité'),
(10, 2, 3, 4, 'Administrateur_formation'),
(11, 2, 11, 16, 'Professeurs'),
(12, 2, 17, 22, 'Stagiaires'),
(13, 11, 14, 15, 'Professeur informatique '),
(14, 11, 12, 13, 'professeur compatbilité'),
(15, 12, 20, 21, 'stagiaire informatique'),
(16, 12, 18, 19, 'stagiaire comptabilité');

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_users`
--

CREATE TABLE IF NOT EXISTS `mle6g_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `mle6g_users`
--

INSERT INTO `mle6g_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(432, 'Super Utilisateur', 'gretaformation', 'greta@greta.fr', '$2y$10$TaBTgv6OTORKqHKefNlRNuloov2rXTfD89jLd/YCBjSX4/zZMUDmG', 0, 1, '2016-10-10 09:24:41', '2016-10-10 14:26:01', '0', '', '0000-00-00 00:00:00', 0, '', '', 0),
(433, 'prof1', 'prof1', 'prof1@pro.fe', '$2y$10$KQl.a9Al6uQ41Rmj2w9j9uGa.0mSyVTFFIf4rw3nHe1J4rV0BQIoq', 0, 0, '2016-10-10 09:35:25', '2016-10-14 14:59:22', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
(434, 'prof2', 'prof2', 'prof2@pro.fr', '$2y$10$VIsy7nwhujz6bCeRMWMs.e3HV4k//RIW9ae.mXrlBfBtKLIqzNr7e', 0, 0, '2016-10-10 09:35:54', '2016-10-10 11:29:23', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
(435, 'stag1', 'stag1', 'stag1@sta.fr', '$2y$10$cZ9XmalJtxc82i9YrBJGVufh1zjl.9khLxOMvIQtc49vOrxSrtaaW', 0, 0, '2016-10-10 09:36:22', '2016-10-10 11:38:28', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
(436, 'stag2', 'stag2', 'stag2@sta.fr', '$2y$10$Ni/ke430F/uWpTWaaNALQevaV8gQeLysB.udoIo9CB6mZ5LPNLpVO', 0, 0, '2016-10-10 09:36:46', '0000-00-00 00:00:00', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_user_keys`
--

CREATE TABLE IF NOT EXISTS `mle6g_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `mle6g_user_notes`
--

CREATE TABLE IF NOT EXISTS `mle6g_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Structure de la table `mle6g_user_profiles`
--

CREATE TABLE IF NOT EXISTS `mle6g_user_profiles` (
...
--
-- Structure de la table `mle6g_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `mle6g_user_usergroup_map` (
...
--
-- Contenu de la table `mle6g_user_usergroup_map`
--

INSERT INTO `mle6g_user_usergroup_map` (`user_id`, `group_id`) VALUES
(432, 8),
(433, 2),
(433, 14),
(434, 2),
...
--
-- Structure de la table `mle6g_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `mle6g_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Contenu de la table `mle6g_utf8_conversion`
--

INSERT INTO `mle6g_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Structure de la table `mle6g_viewlevels`
--

CREATE TABLE IF NOT EXISTS `mle6g_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Contenu de la table `mle6g_viewlevels`
--

INSERT INTO `mle6g_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Accès public', 0, '[1]'),
(2, 'Accès enregistré', 2, '[6,2,8]'),
(3, 'Accès spécial', 3, '[6,3,8]'),
(5, 'Accès invité', 1, '[9]'),
(6, 'Accès super utilisateur', 4, '[8]'),
(7, 'bts compta', 0, '[10,11,16]'),
(8, 'bts info', 0, '[10,11,15]');
...
CREATE TABLE IF NOT EXISTS `modules` (
  `idModules` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `idCompetence` int(10) unsigned NOT NULL,
  `idMatiere` int(10) unsigned NOT NULL,
  `idTheme` int(10) unsigned NOT NULL,
  `idFormateurs_suivi` int(10) unsigned DEFAULT NULL,
  `idFormateurs_createur` int(10) unsigned DEFAULT NULL,
  `idParcours` int(10) unsigned DEFAULT NULL,
  `Nom_mod` varchar(45) DEFAULT NULL,
  `descript_mod` varchar(255) DEFAULT NULL,
  `etat_mod` varchar(45) DEFAULT NULL,
  `heure_mod` int(10) unsigned DEFAULT NULL,
  `code_module` varchar(45) DEFAULT NULL,
  `mod_ref` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`idModules`),
  KEY `idFormateurs_suivi` (`idFormateurs_suivi`),
  KEY `idFormateurs_createur` (`idFormateurs_createur`),
  KEY `idTheme` (`idTheme`),
...
INSERT INTO `modules` (`idModules`, `idCompetence`, `idMatiere`, `idTheme`, `idFormateurs_suivi`, `idFormateurs_createur`, `idParcours`, `Nom_mod`, `descript_mod`, `etat_mod`, `heure_mod`, `code_module`, `mod_ref`) VALUES
(1, 1, 1, 1, NULL, NULL, NULL, 'php', 'programmer en php', NULL, NULL, NULL, 1),
(2, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 1),
(3, 2, 1, 3, NULL, NULL, NULL, 'SQL2', 'programmer en Sql', NULL, NULL, NULL, 1),
(4, 2, 1, 3, NULL, NULL, NULL, 'SQL3', 'programmer en Sql', NULL, NULL, NULL, 1),
(5, 2, 1, 3, NULL, NULL, NULL, 'SQL4', 'programmer en Sql', NULL, NULL, NULL, 1),
(6, 2, 1, 3, NULL, NULL, NULL, 'SQL5', 'programmer en Sql', NULL, NULL, NULL, 1),
(7, 2, 1, 3, NULL, NULL, NULL, 'SQL6', 'programmer en Sql', NULL, NULL, NULL, 1),
(8, 2, 1, 3, NULL, NULL, NULL, 'SQL7', 'programmer en Sql', NULL, NULL, NULL, 1),
(9, 2, 1, 1, NULL, NULL, NULL, 'SQL8', 'programmer en Sql', NULL, NULL, NULL, 1),
(10, 1, 1, 1, NULL, NULL, NULL, 'cdi', 'concepteur developpeur info', NULL, NULL, NULL, 1),
(11, 2, 2, 3, NULL, NULL, NULL, 'compteur', 'apprendre a compter', NULL, NULL, NULL, 1),
(12, 3, 3, 2, NULL, NULL, NULL, 'reseauter', 'apprendre a fabriquer le reseau', NULL, NULL, NULL, 1),
(13, 3, 1, 2, NULL, NULL, NULL, 'manger du code', 'codeur', NULL, NULL, NULL, 1),
(14, 2, 1, 2, NULL, NULL, NULL, 'base de données', 'bdd les bases', NULL, NULL, NULL, 1),
(15, 2, 1, 1, NULL, NULL, NULL, 'hgrfh', 'apprendre a compter', NULL, NULL, NULL, 1),
(16, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(17, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(18, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(19, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(20, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(21, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(22, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(23, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(24, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(25, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(26, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(27, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(28, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(29, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(30, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(31, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(32, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(33, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(34, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(35, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(36, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(37, 3, 2, 3, NULL, NULL, NULL, 'php', 'apprendre a compter', NULL, NULL, NULL, 1),
(38, 2, 3, 2, NULL, NULL, NULL, 'SQL', 'hgdfshdgf', NULL, NULL, NULL, 1),
(39, 3, 2, 1, NULL, NULL, NULL, 'compteur', 'hgdfshdgf', NULL, NULL, NULL, 1),
(40, 2, 1, 3, NULL, NULL, NULL, 'UML', 'cours de Catherine', NULL, NULL, NULL, 1),
(57, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0),
(58, 1, 1, 1, NULL, NULL, NULL, 'cdi', 'concepteur developpeur info', NULL, NULL, NULL, 0),
(59, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0),
(60, 2, 2, 3, NULL, NULL, NULL, 'compteur', 'apprendre a compter', NULL, NULL, NULL, 0),
(61, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0),
(62, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0),
(63, 2, 1, 3, NULL, NULL, NULL, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0),
(64, 2, 1, 3, NULL, NULL, 39, 'SQL1', 'programmer en Sql', NULL, NULL, NULL, 0);
...
CREATE TABLE IF NOT EXISTS `parcours` (
  `idParcours` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `idFormation` int(10) unsigned NOT NULL,
  `idStagiaire` int(10) unsigned NOT NULL,
  `Date_Deb_Parcours` date DEFAULT NULL,
  `Date_Fin_Parc` date DEFAULT NULL,
...
INSERT INTO `parcours` (`idParcours`, `idFormation`, `idStagiaire`, `Date_Deb_Parcours`, `Date_Fin_Parc`) VALUES
(34, 17, 59, NULL, NULL),
(35, 17, 59, NULL, NULL),
(36, 17, 59, NULL, NULL),
(37, 17, 61, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `stagiaire` (
  ...
  `code_stagiaire` varchar(45) DEFAULT NULL,
  `nom_stagiaire` varchar(45) DEFAULT NULL,
  `prenom_stagiaire` varchar(45) DEFAULT NULL,
  `log_stagiaire` varchar(45) DEFAULT NULL,
  `mdp_stagiaire` varchar(45) DEFAULT NULL,
...
INSERT INTO `stagiaire` (`idStagiaire`, `code_stagiaire`, `nom_stagiaire`, `prenom_stagiaire`, `log_stagiaire`, `mdp_stagiaire`) VALUES
(59, NULL, 'peyre', 'xavier', NULL, NULL),
(60, NULL, 'peyre', 'xavier', NULL, NULL),
(61, NULL, 'vaderbosse', 'jeremy', NULL, NULL),
(62, NULL, 'peyre', 'buffin', NULL, NULL),
(63, NULL, 'peyre', 'buffin', NULL, NULL),
(64, NULL, 'peyre', 'buffin', NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `suivit_peda`
--

CREATE TABLE IF NOT EXISTS `suivit_peda` (
  `idParcours` int(10) unsigned NOT NULL,
  `id_Detail` int(10) unsigned NOT NULL,
  `Commentaire` varchar(255) DEFAULT NULL,
  `Date_Eval` date DEFAULT NULL,
  `Eval` smallint(5) unsigned DEFAULT NULL,
  `Date_Reeval` date DEFAULT NULL,
  `Reeval` smallint(5) unsigned DEFAULT NULL,
...
--
-- Structure de la table `suivit_quotidien`
--

CREATE TABLE IF NOT EXISTS `suivit_quotidien` (
  `idParcours` int(10) unsigned NOT NULL,
  `id_Detail` int(10) unsigned NOT NULL,
  `idDate` datetime NOT NULL,
  `Nbre_heure` int(10) unsigned DEFAULT NULL,
  `Commentaire_eleve` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `theme` (
  ...
  `code_theme` varchar(45) DEFAULT NULL,
  `Nom_theme` varchar(255) DEFAULT NULL,
  `couleur_th` varchar(45) DEFAULT NULL,
  `etat_th` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idTheme`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
INSERT INTO `theme` (`idTheme`, `code_theme`, `Nom_theme`, `couleur_th`, `etat_th`) VALUES
(1, NULL, 'programation', 'bleu', NULL),
(2, NULL, 'developpement', 'vert', NULL),
(3, NULL, 'conception', 'rouge', NULL);
...
CREATE TABLE IF NOT EXISTS `type_formation` (
  `idType_Form` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nom_typeForm` varchar(45) DEFAULT NULL,
...
INSERT INTO `type_formation` (`idType_Form`, `nom_typeForm`) VALUES
(1, 'titre'),
(2, 'diplome'),
(3, 'à la carte');
...
ALTER TABLE `contenu_parcours`
  ADD CONSTRAINT `contenu_parcours_ibfk_1` FOREIGN KEY (`idFormation`) REFERENCES `formation` (`idFormation`),
  ADD CONSTRAINT `contenu_parcours_ibfk_2` FOREIGN KEY (`idModules`) REFERENCES `modules` (`idModules`);

--
-- Contraintes pour la table `detail`
--
ALTER TABLE `detail`
  ADD CONSTRAINT `detail_ibfk_1` FOREIGN KEY (`idDetailParent`) REFERENCES `modules` (`idModules`),
  ADD CONSTRAINT `fk_det_idtheme` FOREIGN KEY (`idTheme`) REFERENCES `theme` (`idTheme`);

--
-- Contraintes pour la table `detail_module`
--
ALTER TABLE `detail_module`
  ADD CONSTRAINT `detail_module_ibfk_1` FOREIGN KEY (`idModules`) REFERENCES `modules` (`idModules`),
  ADD CONSTRAINT `detail_module_ibfk_2` FOREIGN KEY (`id_Detail`) REFERENCES `detail` (`id_Detail`);

--
-- Contraintes pour la table `formation`
--
ALTER TABLE `formation`
  ADD CONSTRAINT `formation_ibfk_1` FOREIGN KEY (`idType_Form`) REFERENCES `type_formation` (`idType_Form`),
  ADD CONSTRAINT `formation_ibfk_2` FOREIGN KEY (`idAdmin_parcours`) REFERENCES `admin_parcours` (`idAdmin_parcours`),
  ADD CONSTRAINT `formation_ibfk_3` FOREIGN KEY (`idFormateurs`) REFERENCES `formateurs` (`idFormateurs`);

--
-- Contraintes pour la table `image`
--
ALTER TABLE `image`
  ADD CONSTRAINT `fk_stag_idstag` FOREIGN KEY (`idStagiaire`) REFERENCES `stagiaire` (`idStagiaire`);

--
-- Contraintes pour la table `modules`
--
ALTER TABLE `modules`
  ADD CONSTRAINT `modules_ibfk_1` FOREIGN KEY (`idFormateurs_suivi`) REFERENCES `formateurs` (`idFormateurs`),
  ADD CONSTRAINT `modules_ibfk_2` FOREIGN KEY (`idFormateurs_createur`) REFERENCES `formateurs` (`idFormateurs`),
  ADD CONSTRAINT `modules_ibfk_3` FOREIGN KEY (`idTheme`) REFERENCES `theme` (`idTheme`),
  ADD CONSTRAINT `modules_ibfk_4` FOREIGN KEY (`idMatiere`) REFERENCES `matiere` (`idMatiere`),
  ADD CONSTRAINT `modules_ibfk_5` FOREIGN KEY (`idCompetence`) REFERENCES `competence` (`idCompetence`),
  ADD CONSTRAINT `modules_ibfk_6` FOREIGN KEY (`idParcours`) REFERENCES `parcours` (`idParcours`);

--
-- Contraintes pour la table `parcours`
--
ALTER TABLE `parcours`
  ADD CONSTRAINT `parcours_ibfk_1` FOREIGN KEY (`idStagiaire`) REFERENCES `stagiaire` (`idStagiaire`),
  ADD CONSTRAINT `parcours_ibfk_2` FOREIGN KEY (`idFormation`) REFERENCES `formation` (`idFormation`);

--
-- Contraintes pour la table `suivit_peda`
--
ALTER TABLE `suivit_peda`
  ADD CONSTRAINT `suivit_peda_ibfk_1` FOREIGN KEY (`idParcours`) REFERENCES `parcours` (`idParcours`),
  ADD CONSTRAINT `suivit_peda_ibfk_2` FOREIGN KEY (`id_Detail`) REFERENCES `detail` (`id_Detail`);

--
-- Contraintes pour la table `suivit_quotidien`
--
ALTER TABLE `suivit_quotidien`
  ADD CONSTRAINT `suivit_quotidien_ibfk_1` FOREIGN KEY (`idParcours`) REFERENCES `parcours` (`idParcours`),
  ADD CONSTRAINT `suivit_quotidien_ibfk_2` FOREIGN KEY (`id_Detail`) REFERENCES `detail` (`id_Detail`),
  ADD CONSTRAINT `suivit_quotidien_ibfk_3` FOREIGN KEY (`idDate`) REFERENCES `date` (`idDate`);
